...
class Devise::SamlSessionsController < Devise::SessionsController
  ...
  def new
    ...
    action = auth_request.create(saml_config(params, request), auth_params || {})
  ...
  def metadata
    ...
    render xml: meta.generate(saml_config(params, request))
  end

  def idp_sign_out
    if params[:SAMLRequest] && Devise.saml_session_index_key
      saml_config = saml_config(params, request)
  ...
  def after_sign_out_path_for(_)
    ...
    saml_settings = saml_config(params, request).dup
